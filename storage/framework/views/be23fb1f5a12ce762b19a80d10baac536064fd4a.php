...
<li class="nav-item">
    <a href="<?php echo e(route('user.program.index')); ?>" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<li class="nav-item">
    <a href="<?php echo e(route('user.task.index')); ?>" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<li class="nav-item">
    <a href="<?php echo e(route('user.user.show',\Illuminate\Support\Facades\Auth::id())); ?>" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<?php /**PATH C:\xampp\htdocs\uctcweb\resources\views/tools/menu/user.blade.php ENDPATH**/ ?>