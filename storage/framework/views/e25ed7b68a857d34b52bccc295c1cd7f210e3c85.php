        ...
        <div class="text-center shadow-sm profile-box">
            <div class="miniOption position-relative">
                <div class="iconOptionCenter position-absolute">
                    <a href="<?php echo e(route('admin.user.edit', $user)); ?>" class="iconOption">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\uctcweb\resources\views/1stRoleBlades/profile.blade.php ENDPATH**/ ?>