...
<?php $__env->startSection('content'); ?>
    <div class="container" style="margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col">
                <form action="<?php echo e(route('lecturer.actionTask.store')); ?>" method="post">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/2ndRoleBlades/addTaskAction.blade.php ENDPATH**/ ?>