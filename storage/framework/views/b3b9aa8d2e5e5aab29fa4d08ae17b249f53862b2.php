...
<?php $__env->startSection('content'); ?>
    <div class="container" style="margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col">
                <form action="<?php echo e(route('coordinator.program.store')); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="created_by" class="custom-select">
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>"><?php echo e($user->identity->name); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/1stRoleBlades/addProgram.blade.php ENDPATH**/ ?>