...
<li class="nav-item">
    <a href="<?php echo e(route('admin.program.index')); ?>" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<li class="nav-item">
    <a href="<?php echo e(route('admin.proposal.index')); ?>" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<li class="nav-item">
    <a href="<?php echo e(route('admin.user.show',\Illuminate\Support\Facades\Auth::id())); ?>" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<?php /**PATH C:\xampp\htdocs\uctcweb\resources\views/tools/menu/admin.blade.php ENDPATH**/ ?>