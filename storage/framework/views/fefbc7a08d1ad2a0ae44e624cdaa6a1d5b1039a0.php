    ...
    <?php if(auth()->guard()->check()): ?>
        <div class="clearfix">
            ...
            <div class="float-right">
                 <a href="<?php echo e(route('lecturer.user.create')); ?>" role="button" aria-pressed="true">
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fad"
            ...
            <div class="quiz-window-body">
                <div class="gui-window-awards">
                    ...
                    <ul class="quiz-window-body guiz-awards-row guiz-awards-row-margin mb-2 budget">
                        ...
                        <li class="guiz-awards-time customComittee"><?php echo e($user->role_id); ?></li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/2ndRoleBlades/listUser.blade.php ENDPATH**/ ?>