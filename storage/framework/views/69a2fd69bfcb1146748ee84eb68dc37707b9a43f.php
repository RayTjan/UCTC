    ...
    <?php if(auth()->guard()->check()): ?>
        <div class="clearfix">
            ...
            <div class="float-right">
                 <a href="<?php echo e(route('staff.user.create')); ?>" role="button" aria-pressed="true">
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fad"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\uctcweb\resources\views/2ndRoleBlades/listUser.blade.php ENDPATH**/ ?>