...
<li class="nav-item">
    <a href="<?php echo e(route('student.program.index')); ?>" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<li class="nav-item">
    <a href="<?php echo e(route('student.user.show',\Illuminate\Support\Facades\Auth::id())); ?>" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/tools/menu/user.blade.php ENDPATH**/ ?>