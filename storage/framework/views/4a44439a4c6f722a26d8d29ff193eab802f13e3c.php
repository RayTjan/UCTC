                                        ...
                                        <div class="dropdown">
                                            <div class="dropdown show">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <form action="<?php echo e(route('lecturer.client.edit', $client->id)); ?>"
                                                          method="POST">
                                                    ...
                                                    <form action="<?php echo e(route('lecturer.client.destroy', $client->id)); ?>"
                                                          method="POST">
                                                        <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/2ndRoleBlades/listClientProgram.blade.php ENDPATH**/ ?>