...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container clearfix" style="margin-top: 20px;">
        ...
        <div>
            ...
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="<?php echo e(route('lecturer.action.show',$program)); ?>" class="a-none blackhex d-inline-block">
                <h6>Action Plan</h6>
            </a>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/2ndRoleBlades/listActionPlan.blade.php ENDPATH**/ ?>