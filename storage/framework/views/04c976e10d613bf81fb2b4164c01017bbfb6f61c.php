...
<?php $__env->startSection('content'); ?>
    <div class="container" style="margin-top: 20px;">
        ...
        <div class="d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('student.file.show',$program)); ?>" class="circular graystar font-weight-bold p-2 gray-hover">
        ...
        <div class="d-flex justify-content-between mb-5">
            <div class="">
                <?php if($program->status == '1'||$program->status == '2'): ?>
                <a href="<?php echo e(route('student.client.show', $program)); ?>" title="Client" class="circular yellowstar font-weight-bold p-2 yellow-hover mr-2">
                    <i class="fa fa-user"></i>
                    Client
                </a>
                <a href="<?php echo e(route('student.committee.show', $program)); ?>" title="Committee" class="circular cyanstar font-weight-bold p-2 cyan-hover mr-2">
                    <i class="fa fa-user"></i>
                    Committee
                </a>
                <a href="<?php echo e(route('student.action.show', $program)); ?>" title="Action Plan" class="circular bluestar font-weight-bold p-2 blue-hover mr-2">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header card-bg-change">
                        <?php if($edit == true): ?>
                        <a href="<?php echo e(route('student.finance.show', $program)); ?>" class="circular yellowstar font-weight-bold p-2 yellow-hover">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body d-inline-block text-center" style="text-align: left;">
                        <form action="<?php echo e(route('student.program.destroy', $program)); ?>" method="post" class="d-inline-block">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/3rdRoleBlades/detailProgram.blade.php ENDPATH**/ ?>