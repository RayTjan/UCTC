...
<?php $__env->startSection('content'); ?>
    <div class="container" style="margin-top: 20px;">
        ...
        <div class="d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('lecturer.file.show',$program)); ?>" class="circular graystar font-weight-bold p-2 gray-hover">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header card-bg-change">
                        <?php if($edit == true): ?>
                        <a href="<?php echo e(route('lecturer.finance.show', $program)); ?>" class="circular yellowstar font-weight-bold p-2 yellow-hover">
                            <i class="fa fa-money"></i>
                            Finance
                        </a>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\uctcweb\resources\views/2ndRoleBlades/detailProgram.blade.php ENDPATH**/ ?>