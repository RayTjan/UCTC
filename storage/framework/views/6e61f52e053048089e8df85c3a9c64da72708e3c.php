    ...
    <div class="container clearfix" style="margin-top: 20px;">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="align-self-center">
                ...
                <div>
                    <form action="<?php echo e(route('coordinator.program.coor')); ?>"
                    ...
                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <form action="<?php echo e(route('coordinator.program.filterProgramType')); ?>"
                              method="GET" class="d-inline-block mr-1">
                            <?php echo e(csrf_field()); ?>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <form action="<?php echo e(route('coordinator.program.filterProgramCategory')); ?>"
                              method="GET" class="d-inline-block mr-1">
                            <?php echo e(csrf_field()); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <form action="<?php echo e(route('coordinator.program.filterProgramStatus')); ?>"
                          method="GET" class="d-inline-block mr-1">
                        <?php echo e(csrf_field()); ?>
            ...
            <div class="clearfix align-self-center">
                <div class="">
                    <a href="<?php echo e(route('coordinator.program.create')); ?>" role="button" aria-pressed="true">
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fad"
                ...
                <div class="quiz-window-body">
                    <div class="gui-window-awards">
                        ...
                        <ul class="
                            ...
                            <?php endif; ?>
                                quizz">
                            <a href="<?php echo e(route('coordinator.program.show',$program)); ?>" class="a-none">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/1stRoleBlades/listProgramCoor.blade.php ENDPATH**/ ?>