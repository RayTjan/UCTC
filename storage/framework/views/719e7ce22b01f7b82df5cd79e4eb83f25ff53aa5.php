...
<?php $__env->startSection('content'); ?>
    ...
    <div>
        ...
        <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
        <a href="<?php echo e(route('lecturer.fund.show',$program)); ?>" class="a-none blackhex d-inline-block">
            <h6>Reimburse</h6>
        </a>
    </div>
    <div class="d-flex justify-content-between">
        <h1 class="col font-weight-bold">Reimburse List <?php echo e($program->name); ?></h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content card-bg-change">
                ...
                <div class="modal-body" style="text-align: left;">
                    <form action="<?php echo e(route ('lecturer.fund.store')); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body d-inline-block text-center" style="text-align: left;">
                                                <form action="<?php echo e(route('lecturer.fund.destroy', $fund)); ?>" method="post" class="d-inline-block">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <div class="modal fade" id="editfund-<?php echo e($fund->id); ?>">
                                    <div class="modal-dialog">
                                        <div class="modal-content card-bg-change">
                                            ...
                                            <!-- Modal body -->
                                            <div class="modal-body" style="text-align: left;">
                                                <form action="<?php echo e(route ('lecturer.fund.update',$fund)); ?>" method="POST" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <?php echo e(csrf_field()); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <label>Value: </label>
                                                            <input type="number" class="form-control" name="value" value="<?php echo e($fund->value); ?>" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Date: </label>
