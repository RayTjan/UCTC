...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container clearfix" style="margin-top: 20px;">
        ...
        <div>
            <a href="<?php echo e(route('lecturer.program.show',$action->program)); ?>" class="a-none blackhex d-inline-block">
                <h6>Program</h6>
            </a>
            ...
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="<?php echo e(route('lecturer.action.show',$action->program)); ?>" class="a-none blackhex d-inline-block">
                <h6>Action Plan</h6>
            </a>
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="<?php echo e(route('lecturer.action.show',$action)); ?>" class="a-none blackhex d-inline-block">
                <h6>Task</h6>
            </a>
        </div>
