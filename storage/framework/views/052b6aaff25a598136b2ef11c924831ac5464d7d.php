...
<?php $__env->startSection('content'); ?>
    <div class="container" style="margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col">
                <form action="<?php echo e(route('lecturer.program.update', $program)); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body d-inline-block text-center" style="text-align: left;">
                                <form action="<?php echo e(route('lecturer.program.finish', $program->id)); ?>" method="post" class="d-inline-block">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/2ndRoleBlades/editProgram.blade.php ENDPATH**/ ?>