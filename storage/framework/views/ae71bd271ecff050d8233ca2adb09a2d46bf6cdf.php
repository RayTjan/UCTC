                                        ...
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <form action="<?php echo e(route('staff.client.edit', $client->id)); ?>"
                                                    ...
                                                    <input name="selected_program" type="hidden" value="<?php echo e($client->id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\uctcweb\resources\views/2ndRoleBlades/listClient.blade.php ENDPATH**/ ?>