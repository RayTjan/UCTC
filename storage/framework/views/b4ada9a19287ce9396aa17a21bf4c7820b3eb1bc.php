...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container clearfix" style="margin-top: 20px;">
        <div class="d-flex justify-content-between mb-3">
            ...
            <a href="<?php echo e(route('student.actionTask.create', $action->id)); ?>" role="button" aria-pressed="true">
                <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
        ...
        <div class="row">
            <div class="card-task card-bg-change">
                <div class="quiz-window">
                    <div class="card-bg-change scrollWebkit height100">
                        ...
                        <a onclick="detailShow('detailTask-<?php echo e($task->id); ?>')" class="a-none">
                            <ul class="quiz-window-body guiz-awards-row guiz-awards-row-margin quizz borderquiz mb-2">
                                    <li class="guiz-awards-title blackhex"><?php echo e($task->name); ?>
                                    ...
                                    <li class="guiz-awards-time text-right blackhex"><?php echo e(substr(str_replace("-","/",date("d-m-Y", strtotime($task->due_date))),0,5)); ?></li>
            ...
            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('3rdRoleBlades.detailTaskAction', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Program\XAMPP\htdocs\sem3\UAS\uctc\uctcweb\resources\views/3rdRoleBlades/listTaskAction.blade.php ENDPATH**/ ?>