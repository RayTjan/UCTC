...
@section('content')
    ...
    <div class="container clearfix" style="margin-top: 20px;">
        ...
        {{--        navigation--}}
        <div>
            <a href="{{route('coordinator.program.show',$action->program)}}" class="a-none blackhex d-inline-block">
                <h6>Program</h6>
            </a>
            ...
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="{{route('coordinator.action.show',$action->program)}}" class="a-none blackhex d-inline-block">
                <h6>Action Plan</h6>
            </a>
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="{{route('coordinator.action.show',$action)}}" class="a-none blackhex d-inline-block">
                <h6>Task</h6>
            </a>
        </div>
