    ...
    <div class="container clearfix" style="margin-top: 20px;">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="align-self-center">
                ...
                <div>
                    <form action="{{route('coordinator.program.coor')}}"
                    ...
                    @foreach($types as $type)
                        <form action="{{route('coordinator.program.filterProgramType')}}"
                              method="GET" class="d-inline-block mr-1">
                            {{ csrf_field() }}
                        ...
                        {{--                        <a href="{{route('coordinator.program.filterProgram')}}" class="btn btn-primary btn-block" role="button" aria-pressed="true">$type->name</a>--}}
                    @endforeach
                    @foreach($categories as $category)
                        <form action="{{route('coordinator.program.filterProgramCategory')}}"
                              method="GET" class="d-inline-block mr-1">
                            {{ csrf_field() }}
                    ...
                    @endforeach
                    <form action="{{route('coordinator.program.filterProgramStatus')}}"
                          method="GET" class="d-inline-block mr-1">
                        {{ csrf_field() }}
            ...
            <div class="clearfix align-self-center">
                <div class="">
                    <a href="{{route('coordinator.program.create')}}" role="button" aria-pressed="true">
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fad"
                ...
                <div class="quiz-window-body">
                    <div class="gui-window-awards">
                        ...
                        <ul class="
                            ...
                            @endif
                                quizz">
                            <a href="{{route('coordinator.program.show',$program)}}" class="a-none">
