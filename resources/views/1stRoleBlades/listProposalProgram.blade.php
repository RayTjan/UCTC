...
@section('content')
    ...
    <div class="container clearfix" style="margin-top: 20px;">
        ...
        <div>
            ...
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="{{route('coordinator.proposal.show',$program)}}" class="a-none blackhex d-inline-block">
                <h6>Proposal</h6>
            </a>
        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content card-bg-change">
                        ...
                        <div class="modal-body" style="text-align: left;">
                            <form action="{{route ('coordinator.proposal.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal fade" id="replaceProposal-{{$proposal->id}}">
                                            <div class="modal-dialog">
                                                <div class="modal-content card-bg-change">
                                                    ...
                                                    <!-- Modal body -->
                                                    <div class="modal-body" style="text-align: left;">
                                                        <form action="{{route ('coordinator.proposal.update', $proposal)}}" method="POST" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                {{ csrf_field() }}
