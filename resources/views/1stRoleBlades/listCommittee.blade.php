                            ...
                            <div class="modal fade" id="editCom-{{$committee->id}}">
                                <div class="modal-dialog">
                                    <div class="modal-content card-bg-change">
                                        ...
                                        <!-- Modal body -->
                                        <div class="modal-body" style="text-align: left;">
                                            <form action="{{route ('coordinator.committee.update', $committee)}}" method="POST">
                                                <div class="form-group">
                                                    {{ csrf_field() }}
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body d-inline-block text-center" style="text-align: left;">
                                            <form action="{{ route('coordinator.committee.destroy', $committee) }}" method="post" class="d-inline-block">
                                                @csrf
