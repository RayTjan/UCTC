...
<li class="nav-item">
    <a href="" class="nav-link">
        ...
        <span class="link-text">Action Plan</span>
    </a>
</li>
...
<li class="nav-item">
    <a href="{{ route('staff.client.index') }}" class="nav-link">
        <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
        ...
        >
            <g class="fa-group">
                <path
                    fill="currentColor"
                    d="M256,119.631m-87,0a87,87 0,1 1,174 0a87,87 0,1 1,-174 0"
                    class="fa-secondary"
                ></path>
                <path
                    fill="currentColor"
                    d="M432,151.63m-55,0a55,55 0,1 1,110 0a55,55 0,1 1,-110 0"
                    class="fa-secondary"
                ></path>
                <path
                    fill="currentColor"
                    d="M80,151.63m-55,0a55,55 0,1 1,110 0a55,55 0,1 1,-110 0"
                    class="fa-secondary"
                ></path>
                <path
                    fill="currentColor"
                ...
                <path
                    fill="currentColor"
                    d="m279.81,241.03c-43.724,-3.647 -81.729,0.042 -114.51,27.1 -54.857,43.94 -44.3,103.103 -44.3,175.48 0,19.149 15.58,35.02 35.02,35.02 211.082,0 219.483,6.809 232,-20.91 4.105,-9.374 2.98,-6.395 2.98,-96.07 0,-71.226 -61.673,-120.62 -111.19,-120.62z"
                    class="fa-secondary"
                ></path>
                <path
                    fill="currentColor"
