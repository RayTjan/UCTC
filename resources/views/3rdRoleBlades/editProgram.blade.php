...
@section('content')
            ...
            <div class="col">
                <form action="{{route('program.update', $program)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" value="{{ $program->description }}" required>{{ $program->description }}</textarea>
                    </div>
                    <div class="form-group">
                        <label >Goal: </label>
                    ...
                    <div class="form-group">
                        ...
                        <div id="dynamic_field">
                            <div>
                                <input type="number" name="budget[]" placeholder="Enter your Budget" class="form-control name_list d-inline-block budgetForm mr-3" />
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add').click(function(){
                i++;
                $('#dynamic_field').append('<div id="row'+i+'"><input type="number" name="budget[]" placeholder="Enter your Budget" class="form-control name_list d-inline-block budgetForm mr-3" /><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></div>');
            });
