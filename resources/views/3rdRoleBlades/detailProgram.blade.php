...
{{--                        <form action="{{ route('student.program.finish', $program->id) }}" method="post" class="d-inline-block">--}}
{{--                            @csrf--}}
...
{{--        @endif--}}
        ...
        <div class="d-flex justify-content-between mb-5">
            <div class="">
                ...
                <a href="{{ route('student.committee.show', $program) }}" title="Committee" class="circular cyanstar font-weight-bold p-2 cyan-hover mr-2">
                    <i class="fa fa-user"></i>
                    Committee
                </a>
