...
{{--        navigation--}}
        ...
        <div class="position-relative">
            ...
            <div class="card-finance card-bg-change position-absolute">
                ...
                @if($program->status == '1' || $program->status == '2')
                    <div class="clearfix">
                        <a href="{{ route('student.finance.show', $program) }}" class="float-right circular yellowstar font-weight-bold p-1 yellow-hover">
...
{{--                    modal image--}}
        ...
        <div class="d-flex justify-content-between mb-5">
            <div class="align-self-center">
                @if($program->status == '1'||$program->status == '2')
                <a href="{{ route('student.client.show', $program) }}" title="Client" class="circular yellowstar font-weight-bold p-2 yellow-hover mr-2">
                    <i class="fa fa-user"></i>
                    Client
                </a>
                <a href="{{ route('student.committee.show', $program) }}" title="Committee" class="circular yellowstar font-weight-bold p-2 yellow-hover mr-2">
                    <i class="fa fa-user"></i>
                    Committee
                </a>
                ...
                @if($proposal->status == "1")
                    <a href="{{ route('student.report.create', $program) }}" title="Report" class="circular toscastar font-weight-bold p-2 tosca-hover mr-2">
                ...
                @if($program->status == '1' || $program->status == '2')
                    <a href="{{ route('student.action.show', $program) }}" title="Action Plan" class="circular bluestar font-weight-bold p-2 blue-hover mr-2">
                        <i class="fa fa-database"></i>
                        Action Plan
                    </a>

                    <a href="{{route('student.file.show',$program)}}" class="circular graystar font-weight-bold p-2 gray-hover mr-2">
