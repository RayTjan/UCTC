...
@section('content')
    ...
    <div class="container clearfix" style="margin-top: 20px;">
        ...
        <div>
            ...
            <a href="{{route('student.program.show',$action->program)}}" class="a-none blackhex d-inline-block">
                <h6>Detail</h6>
            </a>
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="{{route('student.action.show',$action->program)}}" class="a-none blackhex d-inline-block">
                <h6>Action Plan</h6>
            </a>
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="{{route('student.action.show',$action)}}" class="a-none blackhex d-inline-block">
                <h6>Task</h6>
            </a>
        </div>
