...
@section('content')
    ...
    <div class="container clearfix" style="margin-top: 20px;">
        ...
        <div>
            ...
            <i class="fa fa-angle-right d-inline-block mr-1 ml-1"></i>
            <a href="{{route('student.proposal.show',$program)}}" class="a-none blackhex d-inline-block">
                <h6>Proposal</h6>
            </a>
        </div>
                                    ...
                                    <div class="modal fade" id="replaceProposal-{{$proposal->id}}">
                                        <div class="modal-dialog">
                                            <div class="modal-content card-bg-change">
                                                ...
                                                <!-- Modal body -->
                                                <div class="modal-body" style="text-align: left;">
                                                    <form action="{{route ('student.proposal.update', $proposal)}}" method="POST" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            {{ csrf_field() }}
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body d-inline-block text-center" style="text-align: left;">
                                            <form action="{{ route('student.proposal.destroy', $proposal) }}" method="post" class="d-inline-block">
                                                @csrf
