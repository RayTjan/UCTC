        ...
        <div class="modal-dialog">
            <div class="modal-content card-bg-change">
                ...
                <div class="modal-body" style="text-align: left;">
                    <form action="{{route ('student.fund.store')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body d-inline-block text-center" style="text-align: left;">
                                                <form action="{{ route('student.fund.destroy', $fund) }}" method="post" class="d-inline-block">
                                                    @csrf
                                ...
                                <div class="modal fade" id="editfund-{{$fund->id}}">
                                    <div class="modal-dialog">
                                        <div class="modal-content card-bg-change">
                                            ...
                                            <!-- Modal body -->
                                            <div class="modal-body" style="text-align: left;">
                                                <form action="{{route ('student.fund.update',$fund)}}" method="POST" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        {{ csrf_field() }}
