                    ...
                    <div class="modal-content card-bg-change">
                        ...
                        <div class="modal-body" style="text-align: left;">
                            @if(count($committeeList) > 0)
                                <form action="{{route ('student.committee.store')}}" method="POST">
                            ...
                            <div class="modal fade" id="editCom-{{$committee->id}}">
                                <div class="modal-dialog">
                                    <div class="modal-content card-bg-change">
                                        ...
                                        <!-- Modal body -->
                                        <div class="modal-body" style="text-align: left;">
                                            <form action="{{route ('student.committee.update', $committee)}}" method="POST">
                                                <div class="form-group">
                                                    {{ csrf_field() }}
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body d-inline-block text-center" style="text-align: left;">
                                            <form action="{{ route('student.committee.destroy', $committee) }}" method="post" class="d-inline-block">
                                                @csrf
